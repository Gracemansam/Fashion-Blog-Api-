...
import com.graceman.fashionblogrestapi.model.ErrorMessage;
...
public class RestResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> postAlreadyLikedException(PostAlreadyLikedException exception,
                                                                    WebRequest request) {
        ErrorMessage message = new ErrorMessage(HttpStatus.NOT_FOUND,
                exception.getMessage());
