...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            http.cors().and().csrf().disable().authorizeRequests().antMatchers("/api/auth","/api/register","/api/oauth2/callback").permitAll()
        ...
        public FilterRegistrationBean<CorsFilter> corFilter() {
            ...
            corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:9095/", "google.com","facebook.com"));
